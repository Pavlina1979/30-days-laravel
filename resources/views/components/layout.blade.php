...
<body class="h-full">
  <div class="min-h-full">
    ...
    <header class="relative bg-white shadow-sm">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex place-items-center justify-between">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $heading }}</h1>

        <a class="border rounded-md px-3 py-1" href="{{ route('job.create') }}">Create job</a>
      </div>
    </header>
    <main>
