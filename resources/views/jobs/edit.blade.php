  ...
  <x-slot:heading>Edit job {{ $job->title }}</x-slot>
    ...
    <form method="post" action="{{ route('job.update', $job) }}">
            ...
            <div class="sm:col-span-4">
              ...
              <div class="mt-2">
                <div
                  ...
                  <input id="title" type="text" name="title" placeholder="Project manager" value="{{ $job->title }}"
            ...
            <div class="sm:col-span-4">
              ...
              <div class="mt-2">
                <div
                  ...
                  <input id="salary" type="text" name="salary" placeholder="$50.000" value="{{ $job->salary }}"
                    class="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" />
                </div>
              </div>
              @error('salary')
      ...
      <div class="mt-6 flex items-center justify-between">
        <button form="delete-form">Delete job</button>
    ...
    <form id="delete-form" method="post" action="{{ route('job.delete', $job) }}" class="hidden">
      @csrf
      @method('DELETE')
    </form>
